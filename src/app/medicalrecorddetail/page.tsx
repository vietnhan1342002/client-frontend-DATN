...
function MedicalRecordContent() {
    ...
    const fetchDetailMedicalRecord = async (medicalId: string) => {
        const res = await axios.get(`https://13.211.141.240.nip.io/api/v1/detail-medical-record/medical-record/${medicalId}`);
    ...
    const fetchPrescription = async (medicalDetailId: string) => {
        const res = await axios.get(`https://13.211.141.240.nip.io/api/v1/prescriptions/detail-medical-record/${medicalDetailId}`);
    ...
    const fetchMedicationByPrescriptionId = async (prescriptionId: string) => {
        const res = await axios.get(`https://13.211.141.240.nip.io/api/v1/prescription-details/prescription/${prescriptionId}`);
