...
export default function Home() {
  ...
  const fetchServices = async () => {
    ...
    try {
      const response = await axios.get('https://13.211.141.240.nip.io/api/v1/specialties?pageSize=30');
  ...
  const fetchDoctors = async () => {
    ...
    try {
      const response = await axios.get('https://13.211.141.240.nip.io/api/v1/doctors');
